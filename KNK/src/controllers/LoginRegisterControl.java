...
public class LoginRegisterControl implements Initializable {
    ...
    public void initialize(URL locaiton, ResourceBundle resources) {
        ...
        ObservableList<String> locationList = FXCollections.observableArrayList("Albania", "Kosovo", "Germany",
                "France",
                "Hungary");
    ...
    public void onRegisterAction(ActionEvent e) throws Exception {
        ...
        RegisterUser registerUser = RegisterUser.fromValuesRegister(name, username,
