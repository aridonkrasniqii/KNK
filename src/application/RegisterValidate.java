...
public class RegisterValidate {
  ...
  public static RegisterValidate fromValuesRegister(String name, String username,
      String password, String confirmPassword,
      String email, String birthday,
      String gender, String location) {
    return new RegisterValidate(name, username, password, confirmPassword, email, birthday, gender, location);
  }

  private RegisterValidate(String name, String username,
      String password, String confirmPassword,
      String email, String birthday,
      String gender, String location) {
