...
public class EventController implements Initializable {
    ...
    @FXML
    private TableColumn<Events, Integer> roomNumberCol;
    @FXML
    private TableColumn<Events, Integer> roomFloorCol;
    @FXML
    private TableColumn<Events, Integer> capacityCol;
    @FXML
    private TableColumn<Events, Integer> bedNumberCol;
    @FXML
    private TableColumn<Events, String> roomTypeCol;
    @FXML
    private TableColumn<Events, Double> priceCol;

    ObservableList<Events> events;

    ObservableList<String> eventTypeSelectorList;
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        try {
            initializeRooms();
            events = FXCollections.observableArrayList(loadRooms());
            roomTypeSelector.setItems(eventTypeSelectorList);
