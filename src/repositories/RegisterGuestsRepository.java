...
// InsertQueryBuilder.create("registerGuests")
// .add("id", 0, "i")
...
// public RegisterGuests findByUsernamePassword(String username, String
// password) throws Exception {
// String query = "select * from registerGuests where username = '" +
...
// UpdateQueryBuilder.create("registerGuests")
// .add("first_name", guest.getFirst_name(), "s")
// .add("username", guest.getUsername(), "s")
// .add("email", guest.getEmail(), "s")
// .add("password", guest.getPassword(), "s")
